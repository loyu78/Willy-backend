    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surveyquetion_surveyanswer', models.ManyToManyField(through='survey.NextAnswer', to='survey.SurveyAnswer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recommendedproduct', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='survey.RecommendedProduct')),
                ('surveyanswer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='survey.SurveyAnswer')),
            ],
            options={
