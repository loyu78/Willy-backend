...
class SurveyResultView(View):
    ...
    def post(self, request):
        ...
        try:
            ...
            if len(person_answer)==0 or len(person_answer)== "No":
                result_list = ResultList.objects.get(id=2)

            elif len(history_answer)== "Maybe":
            ...
            user_info = {"age":person.age, "sex":person.gender, "bmi":person.bmi}
            summary   = {"name":person.name, "height":person.height}
