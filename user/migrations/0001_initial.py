    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_deliverystatus', models.ManyToManyField(through='order.Order', to='order.DeliveryStatus')),
                ('user_product', models.ManyToManyField(through='user.Prescription', to='product.Product')),
            ],
            options={
                'db_table': 'users',
            },
